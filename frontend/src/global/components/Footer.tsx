...
const Footer = () => {
    ...
    const socialLinks = [
        {
            href: "https://www.facebook.com/aomailai/",
            label: "Facebook",
            svgPath:
                "M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"
        },
        {
            href: "https://www.instagram.com/aomail_ai/",
            label: "Instagram",
            svgPath:
        ...
        {
            href: "https://www.linkedin.com/company/aomail-ai/",
            label: "LinkedIn",
            svgPath:
                "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"
        },
        {
            href: "https://github.com/aomail-ai/",
            label: "GitHub",
            svgPath:
        ...
        {
            href: "https://www.youtube.com/watch?v=3kms81MLYsM",
            label: "YouTube",
            svgPath:
    ...
    return (
        <footer className="bg-white border-t border-gray-200">
            <div className="mx-auto max-w-7xl px-6 py-10 lg:px-8">
                <div
                    className="flex flex-col items-start space-y-4 sm:flex-row sm:justify-between sm:space-y-0 sm:space-x-4">
                    <div>
                    ...
                    <nav className="flex flex-wrap space-x-4">
                        {navLinks.map(({ href, label }) => (
                            <a
                                key={href}
                                href={href}
                                className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900 link"
                                id={`link-footer-${href}`}
                            >
                                {label}
                            </a>
                    ...
                    <div className="flex gap-6">
                        {socialLinks.map(({ href, svgPath, label }) => (
                            <a
                                key={label}
                                href={href}
                                className="text-gray-400 hover:text-gray-500 link"
