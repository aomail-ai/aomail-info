...
const AccountDeletionConfirmationModal: React.FC<AccountDeletionConfirmationModalProps> = ({
                                                                                               isOpen,
                                                                                               onClose,
                                                                                               onConfirm
                                                                                           }) => {
                ...
                <div className="flex flex-col gap-4 px-8 py-6">
                    <div>
                        <label className="block text-sm font-medium leading-6 text-gray-900">
                            Are you sure you want to delete your account? All the articles you have posted will be
